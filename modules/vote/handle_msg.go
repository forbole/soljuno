...
func HandleMsg(msg types.Instruction, tx types.Tx, db db.VoteDb, client client.ClientProxy) error {
...
func handleMsgInitialize(msg types.Instruction, tx types.Tx, db db.VoteDb) error {
...
func handleMsgAuthorize(msg types.Instruction, tx types.Tx, db db.VoteDb, client client.ClientProxy) error {
...
func handleMsgWithdraw(msg types.Instruction, tx types.Tx, db db.VoteDb, client client.ClientProxy) error {
...
func handleMsgUpdateValidatorIdentity(msg types.Instruction, tx types.Tx, db db.VoteDb, client client.ClientProxy) error {
...
func handleMsgUpdateCommission(msg types.Instruction, tx types.Tx, db db.VoteDb, client client.ClientProxy) error {
...
func handleMsgAuthorizeChecked(msg types.Instruction, tx types.Tx, db db.VoteDb, client client.ClientProxy) error {
