...
func HandleMsg(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgInitialize(msg types.Instruction, tx types.Tx, db db.StakeDb) error {
...
func handleMsgAuthorize(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgDelegate(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgSplit(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgWithdraw(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgDeactivate(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgSetLockup(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgMerge(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgAuthorizeWithSeed(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgInitializeChecked(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgAuthorizeChecked(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgAuthorizeCheckedWithSeed(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
...
func handleMsgSetLockupChecked(msg types.Instruction, tx types.Tx, db db.StakeDb, client client.ClientProxy) error {
